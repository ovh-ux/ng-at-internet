 ...
 */
angular.module("ng-at-internet")
    .directive("atInternetClick", ["atInternet", function (atInternet) {
        return {
            restrict: "A",
            scope: {
                atInternetClick: "="
 ...
 */
angular.module("ng-at-internet")
    .provider("atInternet", ["AT_INTERNET_CUSTOM_VARS", function (AT_INTERNET_CUSTOM_VARS) {
             ...
             */
                trackOrder: function (productData) {
                    ...
                    // create the cart
                        ...
                        var status = productData.status || 3;
